...
function createProductElement(product) {
    ...
    productElement.innerHTML = `
        <div class="bg-gray-100 flex justify-center relative overflow-hidden group cursor-pointer border rounded-xl">
            ...
            <button class="status bg-black text-white absolute bottom-0 left-0 right-0 text-center py-2 translate-y-full transition group-hover:translate-y-0">Add to Card</button>
        </div>
...
function updateCart(e) {
    ...
    cardCount.innerText = cartItemCount.toString();
...
function filterProducts() {
    ...
    productElements.forEach((productElement, index) => {
        ...
        //Show or hide the product based the matches
